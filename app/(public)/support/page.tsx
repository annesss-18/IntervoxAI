...
const quickFixes = [
  { icon: CheckCircle, text: 'Confirm browser microphone permissions are enabled' },
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <Card variant="interactive">
              <CardContent className="p-6">
                <h2 className="mb-4 text-lg font-semibold">Quick troubleshooting</h2>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="mb-4 text-sm text-muted-foreground">
                  When reaching out, please include your session ID, browser version, and a brief description of where the flow failed.
                </p>
