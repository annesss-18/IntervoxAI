...
const sections = [
  {
    ...
    description: "Set up your first interview session in minutes",
  },
  {
    icon: MessageSquare,
    title: "Live Interview",
    description: "How to navigate voice and text interview flows",
  },
  {
    icon: FileText,
    title: "Feedback Reports",
    description: "Understanding your performance insights",
  },
  {
    icon: Zap,
    title: "Templates",
    description: "Creating and customizing interview templates",
  },
];
        ...
        <Container>
          <div className="mb-8 rounded-xl border border-primary/20 bg-primary/5 p-6">
            <p className="text-sm text-muted-foreground">
              ...
              Use the app directly while we expand our guides. The core flow is:
              explore templates → run interviews → review feedback.
            </p>
          </div>
