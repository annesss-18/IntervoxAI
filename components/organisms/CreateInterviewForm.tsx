...
const INTERVIEW_TYPES = [
  {
    value: "Technical",
    label: "Technical",
    desc: "Coding and problem solving depth",
  },
  {
    value: "System Design",
    label: "System Design",
    desc: "Architecture and tradeoff reasoning",
  },
  {
    value: "Behavioral",
    label: "Behavioral",
    desc: "Communication and team collaboration",
  },
  { value: "HR", label: "HR / Fit", desc: "Values, goals, and role fit" },
  {
    value: "Mixed",
    label: "Mixed",
    desc: "Balanced technical and behavioral rounds",
  },
];
...
export function CreateInterviewForm({ userId }: CreateInterviewFormProps) {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setStage("config");
      toast.success(
        "Analysis complete. Review and confirm before creating template.",
      );
    } catch (error) {
      const message =
    ...
    <div className="animate-fadeIn mx-auto w-full max-w-4xl">
      <Card
        ...
        className={cn(
          ...
          stage !== "input" && "pointer-events-none opacity-55",
        )}
      >
        <CardHeader>
        ...
        <CardContent className="space-y-5">
          <Tabs
            ...
            value={jdType}
            onValueChange={(value) =>
              setJdType(value as "text" | "url" | "file")
            }
            className="w-full"
          >
