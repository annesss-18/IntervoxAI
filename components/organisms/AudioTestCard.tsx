...
export function AudioTestCard({
    ...
    const startMicTest = useCallback(async () => {
        try {
            ...
            const poll = () => {
                ...
                // Compute RMS-like normalised level
                let sum = 0;
                ...
                if (level > 0.08) {
                    voiceDetectedCount++;
                    // ~1.5s of voice detected at 60fps ≈ 90 detections
            ...
            // Auto-stop after 15s if no voice detected
    ...
    const startSpeakerTest = useCallback(() => {
        ...
        try {
            // Close prior context to prevent AudioContext leaks on retries.
